...
class ActivityReport(Base):
    ...
    section_intro_verse         = Column(Text, nullable=True)
    section_final_word          = Column(Text, nullable=True)
    section_final_sign_name     = Column(String(200), nullable=True)
    section_final_sign_role     = Column(String(200), nullable=True)
